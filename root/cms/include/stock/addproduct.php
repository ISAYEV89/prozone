<?PHP
	if($_POST['send'])
	{
		...
		$sql=$db->prepare('INSERT INTO stock set `ad`=:ad, `code`=:code');

		$sql->execute(array('ad'=>"$name" , 'code'=>"$barcode" ));
		
		echo "<br><br><center><b><font size='4' color='red'> Product added to Database </font></b></center></br><br>
		<script>
		function redi(){
...
<div class="row">
	...
	<div class="x_panel">
	  <div class="x_title">
		<h2>Add New Product <!--small>different form elements</small --></h2>
		<div class="clearfix"></div>
	  </div>
	  <div class="x_content">
		<br />
		<form  name="form1" method="post" action="" class="form-horizontal form-label-left">
		  ...
		  <div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
			  <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="barcode">
			</div>
		  </div>
