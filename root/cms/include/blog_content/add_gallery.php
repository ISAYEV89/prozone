...
?>
    ...
    <a href="<?php echo $site_url.'blog_content/delete_gallery/'.$image['id'].'/' ?>"><i class="fa fa-trash fa-2x text-danger"></i></a>
    <form method="post" action="<?php echo $site_url.'blog_content/update_gallery/' ?>" style="display:flex;" >
            ...
            if(in_array($extension, $allowTypes)){
                ...
                if(move_uploaded_file($_FILES["files"]["tmp_name"][$key], $targetFilePath)){
                    ...
                    if($key != intval(count($_POST['order'])) - 1 ){
                        $lngins=$db->prepare('INSERT INTO blog_content_gallery set blog_id=:id ,ordering=:ordering,image=:image ');
