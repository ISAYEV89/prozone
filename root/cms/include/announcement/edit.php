...
<?php 
$blogquera=$db->prepare('SELECT * FROM announcement_content where u_id=:uid limit 1 ');
      ...
      <div class="x_content">   
        <form method="POST" action="" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">   
          <div class="w3-container">
            ...
            for($i=0;$i<$lngsay;$i++)
            {
              $blogquers=$db->prepare('SELECT * FROM announcement_content where u_id=:uid and l_id=:lid');
...
if ($_POST['btn']) 
{
  ...
  for ($i=0; $i <$lngsay ; $i++) 
  {
    ...
    { 
      echo 'tttt';
      $lngins=$db->prepare('UPDATE announcement_content set ordering=:ord , description=:sn , name=:nm ,date=:date,youtube_link=:youtube_link, name2=:nm2 , title=:ti ,  stitle=:sti , keyword=:keyw  , s_id=:sid , `text`=:txt  , `text1`=:txt1 , `text2`=:txt2  , picture=:pc where u_id=:uid and l_id=:lng2 ');    
    ...
    {
      $lngins=$db->prepare('UPDATE announcement_content set ordering=:ord , description=:sn , name=:nm ,date=:date,youtube_link=:youtube_link, name2=:nm2 , title=:ti ,  stitle=:sti , keyword=:keyw , u_id=:uid , l_id=:lng2 , s_id=:sid , `text`=:txt  , `text1`=:txt1 , `text2`=:txt2   where u_id=:uid and l_id=:lng2 ');
