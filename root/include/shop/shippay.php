...
if($_SERVER["HTTP_REFERER"]!=$site_url.$lng.'/shop/basket/'  or @!$_SESSION['id'])// check refering page
{
...
else
{
	...
	$a=$db->prepare('SELECT * from `olkeler` where  `l_id` =:lid and kat_id=:olke limit 1');
			...
			$citysql->execute(ARRAY('lid'=>$lng1, 'olke' => $_SESSION['country']));
			...
			<div class="container">
				...
				<div class="middle_content">
					<div class="order_form">
						...
						<form action="<?PHP echo $site_url.$lng.'/shop/review/'?>" id="registr_form" method="post" onsubmit="return validateme()">
							<div class="form_item">
